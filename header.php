<head>
    ...
    <link rel="stylesheet" href="css/wsp.css?v=1.0">
    <link rel="stylesheet" type="text/css" href="css/carousel-thumbnails.css?v=1.0">
    <link rel="stylesheet" type="text/css" href="css/main.css?v=1.0">
    <link rel="stylesheet" type="text/css" href="css/pago_exitoso.css?v=0.2">
