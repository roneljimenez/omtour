            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-12">
                      <div id="accordion" data-aos="fade-right">
                        <div class="card" ng-repeat="itinerario in itinerario_Marruecos">
                ...
                <div class="row" id="descarga-itinerario-wrapper" data-aos="fade-left">
                  <div class="col-12 col-sm-6">
                      <a href="itinerarios\Itinerario_España_Marruecos.pdf" class="btn btn-block btn-itinerario light" target="_blank">Descarga aquí el itinerario</a>
                  </div>
                </div>
            </div>
        </section>
        <section id="hoteles">
          <div class="container">
            ...
            <div class="hotel-wrapper">
              <div class="row" ng-repeat="hotel in hoteles__Marruecos">
                <div class="col-6">
